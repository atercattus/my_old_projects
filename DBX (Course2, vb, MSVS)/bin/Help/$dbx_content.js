...
tocTab[ir++] = new Array ("1", "Знакомство с DBX", "infodbx.htm", "", "cicon37.gif", "cicon37.gif");
tocTab[ir++] = new Array ("2", "Основы работы с программой", "working.htm", "", "cicon17.gif", "cicon17.gif");
tocTab[ir++] = new Array ("3", "Интерфейс программы", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("3.1", "Основное окно", "mainwindow.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("3.2", "Окна мастеров", "masterswindows.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("3.3", "Редактор полей", "recordeditor.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("3.4", "О программе", "aboutprog.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("4", "Мастера", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("4.1", "Мастер запросов", "querymaster.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("4.2", "Мастер диаграмм", "diagmaster.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("4.3", "Мастер защиты", "seqmaster.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("5", "Работа с программой", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("5.1", "Формат запросов", "Форматзапросов.htm", "", "cicon9.gif", "cicon9.gif");
isContent = true,
isIndex = false,
showNumbers = false,
